...
const procedureRegistry = {
  "signUpWithInvitation": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../signup").signUpWithInvitation>("signup:signUpWithInvitation"), () => (require("../signup") as Record<string, unknown>)["signUpWithInvitation"])],
} as const;
...
export function createSignupCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createSignupHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
