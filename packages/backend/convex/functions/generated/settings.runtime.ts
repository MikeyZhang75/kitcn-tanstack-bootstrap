...
const procedureRegistry = {
  "getRegistrationSettings": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "public", typeof import("../settings").getRegistrationSettings>("settings:getRegistrationSettings"), () => (require("../settings") as Record<string, unknown>)["getRegistrationSettings"])],
  "setRequireInvitationCode": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../settings").setRequireInvitationCode>("settings:setRequireInvitationCode"), () => (require("../settings") as Record<string, unknown>)["setRequireInvitationCode"])],
} as const;
...
export function createSettingsCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createSettingsHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
